...
import com.android.waylinkage.adapter.MyRecyclerAdapter;
    ...
    private void initRecyclerView() {
        ...
        adapter.setOnItemClickListener(new MyRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int id) {
                spEd.putInt(KeyConstant.SP_PROJECT_ID, id ).commit();
                context.finish();
        ...
        Response.Listener<JsonObject> successListener = new Response
            ...
            public void onResponse(JsonObject result) {
                ...
                for (int i = 0; i < jsonArray.size(); i++) {
                    ...
                    int id = infoObj.get(KeyConstant.id).getAsInt();
                    String name = infoObj.get(KeyConstant.name).toString().replace("\"", "");
