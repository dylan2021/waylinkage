...
public class SeePicActivity extends BaseFgActivity {
    ...
    private SeePicActivity content;
    ...
    class LoadImageThread extends Thread {
        ...
        public void run() {
            ...
            for (int i = 0; i < imgs.size(); i++) {
                iv = new TouchImageView(SeePicActivity.this);
                String url = imgs.get(i);
                if (url.startsWith("")) {
                    iv.setImageResource(R.drawable.ic_error_img_bg);
                } else {
...
//                imageView = new ImageView(ShowPicActivity.this);
...
//                imageView.setPadding(20, 0, 20, 0);
                ...
                ImageView iv = new ImageView(SeePicActivity.this);
