...
//                Manifest.permission.READ_PHONE_STATE);
    ...
    public static int getVersionCode(Context context) {
        ...
        int versionCode = -1;
        try {
            versionCode = context.getPackageManager().getPackageInfo("com.android.waylinkage", 0)
                    .versionCode;
    ...
    public static String getVersionName(Context context) {
        String verName = "";
        try {
            verName = context.getPackageManager().getPackageInfo("com.android.waylinkage", 0).versionName;
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
        }
        return verName;
