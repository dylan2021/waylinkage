...
public class LoginHelper {
    ...
    public LoginHelper(Context context) {
        ...
        userName = preferences.getString(Constant.SP_USER_NAME, "");
        passWord = preferences.getString(Constant.sp_pwd, "");
    }

    public void reLoadSP() {
        App.phone = preferences.getString(Constant.SP_USER_NAME, "");
        App.passWord = preferences.getString(Constant.sp_pwd, "");
        ...
        App.token = preferences.getString(Constant.SP_TOKEN, "");
    ...
    public void reLogin() {
        ...
        Response.Listener<JsonResult<User>> succesListener = new Response.Listener<JsonResult<User>>() {
            ...
            public void onResponse(JsonResult<User> result) {
                ...
                /*    SharedPreferences.Editor editor = preferences.edit();
                    ...
                    editor.putString(Constant.CONFIG_NICK_NAME, user.username);
                    editor.putString(Constant.SP_USER_NAME, user.loginName);
                    editor.putString(Constant.sp_pwd, App.passWord);
        ...
        Request<JsonResult<User>> versionRequest1 = new GsonRequest<JsonResult<User>>(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(KeyConstant.password, App.passWord);
